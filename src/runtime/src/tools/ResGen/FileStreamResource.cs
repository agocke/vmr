...
internal sealed class FileStreamResource : IResource
{
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        writer.AddActivatorResource(Name, fileStream, TypeAssemblyQualifiedName, closeAfterWrite: true);
    }

    void IResource.AddTo(System.Resources.IResourceWriter writer) => AddTo((PreserializedResourceWriter)writer);
}

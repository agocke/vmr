...
// Hardcoded for darwin-x64 (Bazel build).
...
#define HOST_POLICY_PKG_NAME "runtime.osx-x64.Microsoft.NETCore.DotNetHostPolicy"
#define HOST_POLICY_PKG_REL_DIR "runtime.osx-x64/native"

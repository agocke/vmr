...
#define FireEtwGCAllocationTick_V4(AllocationAmount, AllocationKind, ClrInstanceID, AllocationAmount64, TypeID, TypeName, HeapIndex, Address, ObjectSize) 0
...
#define FireEtwBulkType(Count, ClrInstanceID, Values_ElementSize, Values) 0
#define FireEtwGCBulkRootEdge(Index, Count, ClrInstanceID, Values_ElementSize, Values) 0
#define FireEtwGCBulkRootConditionalWeakTableElementEdge(Index, Count, ClrInstanceID, Values_ElementSize, Values) 0
#define FireEtwGCBulkNode(Index, Count, ClrInstanceID, Values_ElementSize, Values) 0
#define FireEtwGCBulkEdge(Index, Count, ClrInstanceID, Values_ElementSize, Values) 0
...
#define FireEtwGCBulkSurvivingObjectRanges(Index, Count, ClrInstanceID, Values_ElementSize, Values) 0
#define FireEtwGCBulkMovedObjectRanges(Index, Count, ClrInstanceID, Values_ElementSize, Values) 0
...
#define FireEtwGCBulkRootCCW(Count, ClrInstanceID, Values_ElementSize, Values) 0
#define FireEtwGCBulkRCW(Count, ClrInstanceID, Values_ElementSize, Values) 0
#define FireEtwGCBulkRootStaticVar(Count, AppDomainID, ClrInstanceID, Values_ElementSize, Values) 0
#define FireEtwGCDynamicEvent(Name, DataSize, Data, ClrInstanceID) 0
...
#define FireEtwMethodDetails(MethodID, TypeID, MethodToken, TypeParameterCount, LoaderModuleID, TypeParameters) 0
#define FireEtwTypeLoadStart(TypeLoadStartID, ClrInstanceID) 0
#define FireEtwTypeLoadStop(TypeLoadStartID, ClrInstanceID, LoadLevel, TypeID, TypeName) 0
...
#define FireEtwContentionStop_V1(ContentionFlags, ClrInstanceID, DurationNs) 0
...
#define FireEtwR2RGetEntryPoint(MethodID, MethodNamespace, MethodName, MethodSignature, EntryPoint, ClrInstanceID) 0
#define FireEtwR2RGetEntryPointStart(MethodID, ClrInstanceID) 0
...
#define FireEtwMethodJitInliningFailedAnsi(MethodBeingCompiledNamespace, MethodBeingCompiledName, MethodBeingCompiledNameSignature, InlinerNamespace, InlinerName, InlinerNameSignature, InlineeNamespace, InlineeName, InlineeNameSignature, FailAlways, FailReason, ClrInstanceID) 0
...
#define FireEtwMethodJitTailCallFailedAnsi(MethodBeingCompiledNamespace, MethodBeingCompiledName, MethodBeingCompiledNameSignature, CallerNamespace, CallerName, CallerNameSignature, CalleeNamespace, CalleeName, CalleeNameSignature, TailPrefix, FailReason, ClrInstanceID) 0
...
#define FireEtwMethodILToNativeMap_V1(MethodID, ReJITID, MethodExtent, CountOfMapEntries, ILOffsets, NativeOffsets, ClrInstanceID, ILVersionID) 0
...
#define FireEtwModuleLoad_V3(ModuleID, AssemblyID, ModuleFlags, Reserved1, ModuleILPath, ModuleNativePath, ClrInstanceID, ManagedPdbSignature, ManagedPdbAge, ManagedPdbBuildPath, NativePdbSignature, NativePdbAge, NativePdbBuildPath, NativeBuildID) 0
...
#define FireEtwGCGlobalHeapHistory_V4(FinalYoungestDesired, NumHeaps, CondemnedGeneration, Gen0ReductionCount, Reason, GlobalMechanisms, ClrInstanceID, PauseMode, MemoryPressure, CondemnReasons0, CondemnReasons1, Count, Values_ElementSize, Values) 0
#define FireEtwGenAwareBegin(Count, ClrInstanceID) 0
#define FireEtwGenAwareEnd(Count, ClrInstanceID) 0
#define FireEtwGCLOHCompact(ClrInstanceID, Count, Values_ElementSize, Values) 0
#define FireEtwGCFitBucketInfo(ClrInstanceID, BucketKind, TotalSize, Count, Values_ElementSize, Values) 0
...
#define FireEtwTieredCompilationSettings(ClrInstanceID, Flags) 0
#define FireEtwTieredCompilationPause(ClrInstanceID) 0
#define FireEtwTieredCompilationResume(ClrInstanceID, NewMethodCount) 0
#define FireEtwTieredCompilationBackgroundJitStart(ClrInstanceID, PendingMethodCount) 0
#define FireEtwTieredCompilationBackgroundJitStop(ClrInstanceID, PendingMethodCount, JittedMethodCount) 0
#define FireEtwAssemblyLoadStart(ClrInstanceID, AssemblyName, AssemblyPath, RequestingAssembly, AssemblyLoadContext, RequestingAssemblyLoadContext) 0
#define FireEtwAssemblyLoadStop(ClrInstanceID, AssemblyName, AssemblyPath, RequestingAssembly, AssemblyLoadContext, RequestingAssemblyLoadContext, Success, ResultAssemblyName, ResultAssemblyPath, Cached) 0
#define FireEtwResolutionAttempted(ClrInstanceID, AssemblyName, Stage, AssemblyLoadContext, Result, ResultAssemblyName, ResultAssemblyPath, ErrorMessage) 0
#define FireEtwAssemblyLoadContextResolvingHandlerInvoked(ClrInstanceID, AssemblyName, HandlerName, AssemblyLoadContext, ResultAssemblyName, ResultAssemblyPath) 0
...
#define FireEtwAssemblyLoadFromResolveHandlerInvoked(ClrInstanceID, AssemblyName, IsTrackedLoad, RequestingAssemblyPath, ComputedRequestedAssemblyPath) 0
#define FireEtwKnownPathProbed(ClrInstanceID, FilePath, Source, Result) 0
#define FireEtwJitInstrumentationData(ClrInstanceID, MethodFlags, DataSize, MethodID, Data) 0
#define FireEtwJitInstrumentationDataVerbose(ClrInstanceID, MethodFlags, DataSize, MethodID, ModuleID, MethodToken, MethodNamespace, MethodName, MethodSignature, Data) 0
#define FireEtwProfilerMessage(ClrInstanceID, Message) 0
#define FireEtwExecutionCheckpoint(ClrInstanceID, Name, Timestamp) 0
...
#define FireEtwAllocationSampled(AllocationKind, ClrInstanceID, TypeID, TypeName, Address, ObjectSize, SampledByteOffset) 0

#define FireEtwCLRStackWalkDCStart(ClrInstanceID, Reserved1, Reserved2, FrameCount, Stack) 0
#define FireEtwGCSettingsRundown(HardLimit, LOHThreshold, PhysicalMemoryConfig, Gen0MinBudgetConfig, Gen0MaxBudgetConfig, HighMemPercentConfig, BitSettings, ClrInstanceID) 0
...
#define FireEtwMethodDCStartILToNativeMap_V1(MethodID, ReJITID, MethodExtent, CountOfMapEntries, ILOffsets, NativeOffsets, ClrInstanceID, ILVersionID) 0
...
#define FireEtwMethodDCEndILToNativeMap_V1(MethodID, ReJITID, MethodExtent, CountOfMapEntries, ILOffsets, NativeOffsets, ClrInstanceID, ILVersionID) 0
...
#define FireEtwModuleDCEnd_V3(ModuleID, AssemblyID, ModuleFlags, Reserved1, ModuleILPath, ModuleNativePath, ClrInstanceID, ManagedPdbSignature, ManagedPdbAge, ManagedPdbBuildPath, NativePdbSignature, NativePdbAge, NativePdbBuildPath, NativeBuildID) 0
...
#define FireEtwTieredCompilationSettingsDCStart(ClrInstanceID, Flags) 0
#define FireEtwExecutionCheckpointDCEnd(ClrInstanceID, Name, Timestamp) 0
...
#define FireEtwJittedMethodRichDebugInfo(ClrInstanceID, MethodID, ReJITID, ILVersionID, ChunkIndex, DataSize, Data) 0
...
#define FireEtwCCWRefCountChangeAnsi(HandleID, ObjectID, COMInterfacePointer, NewRefCount, AppDomainID, ClassName, NameSpace, Operation, ClrInstanceID) 0
...
#define FireEtwMonoProfilerContextLoaded(ObjectID, AppDomainID, ContextID) 0
#define FireEtwMonoProfilerContextUnloaded(ObjectID, AppDomainID, ContextID) 0
#define FireEtwMonoProfilerAppDomainLoading(AppDomainID) 0
#define FireEtwMonoProfilerAppDomainLoaded(AppDomainID) 0
#define FireEtwMonoProfilerAppDomainUnloading(AppDomainID) 0
#define FireEtwMonoProfilerAppDomainUnloaded(AppDomainID) 0
#define FireEtwMonoProfilerAppDomainName(AppDomainID, AppDomainName) 0
#define FireEtwMonoProfilerJitBegin(MethodID, ModuleID, MethodToken) 0
#define FireEtwMonoProfilerJitFailed(MethodID, ModuleID, MethodToken) 0
#define FireEtwMonoProfilerJitDone(MethodID, ModuleID, MethodToken) 0
#define FireEtwMonoProfilerJitDone_V1(MethodID, ModuleID, MethodToken, Count, Values_ElementSize, Values) 0
#define FireEtwMonoProfilerJitChunkCreated(ChunkID, ChunkSize) 0
#define FireEtwMonoProfilerJitChunkDestroyed(ChunkID) 0
#define FireEtwMonoProfilerJitCodeBuffer(BufferID, BufferSize, BufferType) 0
#define FireEtwMonoProfilerClassLoading(ClassID, ModuleID) 0
#define FireEtwMonoProfilerClassFailed(ClassID, ModuleID) 0
#define FireEtwMonoProfilerClassLoaded(ClassID, ModuleID, ClassName) 0
#define FireEtwMonoProfilerClassLoaded_V1(ClassID, ModuleID, ClassName, Count, Values_ElementSize, Values) 0
#define FireEtwMonoProfilerVTableLoading(VTableID, ClassID, AppDomainID) 0
#define FireEtwMonoProfilerVTableFailed(VTableID, ClassID, AppDomainID) 0
#define FireEtwMonoProfilerVTableLoaded(VTableID, ClassID, AppDomainID) 0
#define FireEtwMonoProfilerModuleLoading(ModuleID) 0
#define FireEtwMonoProfilerModuleFailed(ModuleID) 0
#define FireEtwMonoProfilerModuleLoaded(ModuleID, ModuleName, ModuleSignature) 0
#define FireEtwMonoProfilerModuleUnloading(ModuleID) 0
#define FireEtwMonoProfilerModuleUnloaded(ModuleID, ModuleName, ModuleSignature) 0
#define FireEtwMonoProfilerAssemblyLoading(AssemblyID, ModuleID) 0
#define FireEtwMonoProfilerAssemblyLoaded(AssemblyID, ModuleID, AssemblyName) 0
#define FireEtwMonoProfilerAssemblyUnloading(AssemblyID, ModuleID) 0
#define FireEtwMonoProfilerAssemblyUnloaded(AssemblyID, ModuleID, AssemblyName) 0
#define FireEtwMonoProfilerMethodEnter(MethodID) 0
#define FireEtwMonoProfilerMethodLeave(MethodID) 0
#define FireEtwMonoProfilerMethodTailCall(MethodID) 0
#define FireEtwMonoProfilerMethodExceptionLeave(MethodID) 0
#define FireEtwMonoProfilerMethodFree(MethodID) 0
#define FireEtwMonoProfilerMethodBeginInvoke(MethodID) 0
#define FireEtwMonoProfilerMethodEndInvoke(MethodID) 0
#define FireEtwMonoProfilerExceptionThrow(TypeID, ObjectID) 0
#define FireEtwMonoProfilerExceptionClause(ClauseType, ClauseIdx, MethodID, TypeID, ObjectID) 0
#define FireEtwMonoProfilerGCEvent(GCEventType, GCGeneration) 0
#define FireEtwMonoProfilerGCAllocation(VTableID, ObjectID, ObjectSize) 0
#define FireEtwMonoProfilerGCMoves(Count, Values_ElementSize, Values) 0
#define FireEtwMonoProfilerGCResize(NewSize) 0
#define FireEtwMonoProfilerGCHandleCreated(HandleID, HandleType, ObjectID) 0
#define FireEtwMonoProfilerGCHandleDeleted(HandleID, HandleType) 0
#define FireEtwMonoProfilerGCFinalizing() 0
#define FireEtwMonoProfilerGCFinalized() 0
#define FireEtwMonoProfilerGCFinalizingObject(ObjectID) 0
#define FireEtwMonoProfilerGCFinalizedObject(ObjectID) 0
#define FireEtwMonoProfilerGCRootRegister(RootID, RootSize, RootType, RootKeyID, RootKeyName) 0
#define FireEtwMonoProfilerGCRootUnregister(RootID) 0
#define FireEtwMonoProfilerGCRoots(Count, Values_ElementSize, Values) 0
#define FireEtwMonoProfilerGCHeapDumpStart(HeapCollectParam) 0
#define FireEtwMonoProfilerGCHeapDumpStop() 0
#define FireEtwMonoProfilerGCHeapDumpObjectReference(ObjectID, VTableID, ObjectSize, ObjectGeneration, Count, Values_ElementSize, Values) 0
#define FireEtwMonoProfilerMonitorContention(ObjectID) 0
#define FireEtwMonoProfilerMonitorFailed(ObjectID) 0
#define FireEtwMonoProfilerMonitorAcquired(ObjectID) 0
#define FireEtwMonoProfilerThreadStarted(ThreadID) 0
#define FireEtwMonoProfilerThreadStopping(ThreadID) 0
#define FireEtwMonoProfilerThreadStopped(ThreadID) 0
#define FireEtwMonoProfilerThreadExited(ThreadID) 0
#define FireEtwMonoProfilerThreadName(ThreadID, ThreadName) 0
#define FireEtwMonoProfilerJitDoneVerbose(MethodID, MethodNamespace, MethodName, MethodSignature) 0
#define FireEtwMonoProfilerGCHeapDumpVTableClassReference(VTableID, ClassID, ModuleID, ClassName) 0

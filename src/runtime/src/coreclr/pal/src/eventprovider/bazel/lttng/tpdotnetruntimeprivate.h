...
TRACEPOINT_EVENT_CLASS(
    ...
    GCOptimized_TRACEPOINT_ARGS,
     TP_FIELDS(
        ctf_integer(uint64_t, DesiredAllocation, DesiredAllocation)
        ctf_integer(uint64_t, NewAllocation, NewAllocation)
...
TRACEPOINT_EVENT_CLASS(
    ...
    GCSettings_TRACEPOINT_ARGS,
     TP_FIELDS(
        ctf_integer(uint64_t, SegmentSize, SegmentSize)
        ctf_integer(uint64_t, LargeObjectSegmentSize, LargeObjectSegmentSize)
...
TRACEPOINT_EVENT_CLASS(
    ...
    BGCDrainMark_TRACEPOINT_ARGS,
     TP_FIELDS(
        ctf_integer(uint64_t, Objects, Objects)
        ctf_integer(unsigned short, ClrInstanceID, ClrInstanceID)
    )
)
...
TRACEPOINT_EVENT_CLASS(
    ...
    BGCRevisit_TRACEPOINT_ARGS,
     TP_FIELDS(
        ctf_integer(uint64_t, Pages, Pages)
        ctf_integer(uint64_t, Objects, Objects)
...
TRACEPOINT_EVENT_CLASS(
    ...
    BGCOverflow_TRACEPOINT_ARGS,
     TP_FIELDS(
        ctf_integer(uint64_t, Min, Min)
        ctf_integer(uint64_t, Max, Max)
        ctf_integer(uint64_t, Objects, Objects)
        ctf_integer(unsigned int, IsLarge, IsLarge)
        ctf_integer(unsigned short, ClrInstanceID, ClrInstanceID)
    )
...
#define JittedMethodRichDebugInfo_TRACEPOINT_ARGS \
TP_ARGS( \
...
TRACEPOINT_EVENT_CLASS(
    DotNETRuntimePrivate,
    JittedMethodRichDebugInfo,
    JittedMethodRichDebugInfo_TRACEPOINT_ARGS,
     TP_FIELDS(
...
#define JittedMethodRichDebugInfoT_TRACEPOINT_INSTANCE(name) \
TRACEPOINT_EVENT_INSTANCE(\
    DotNETRuntimePrivate,\
    JittedMethodRichDebugInfo,\
    name ,\
...
TRACEPOINT_EVENT_CLASS(
    ...
    LoaderHeapPrivate_TRACEPOINT_ARGS,
     TP_FIELDS(
        ...
        ctf_integer(uint64_t, Unused2, Unused2)
        ctf_integer(unsigned short, ClrInstanceID, ClrInstanceID)
    )
)
...
JittedMethodRichDebugInfoT_TRACEPOINT_INSTANCE(JittedMethodRichDebugInfo)

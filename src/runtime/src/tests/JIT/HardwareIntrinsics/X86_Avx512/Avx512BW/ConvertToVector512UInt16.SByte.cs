...
namespace JIT.HardwareIntrinsics.X86._Avx512BW.handwritten
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector512UInt16SByte
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            try
            {
                result = typeof(Avx512BW).GetMethod(nameof(Avx512BW.ConvertToVector512UInt16), new Type[] { typeof(Vector256<SByte>) })
            ...
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Avx512BW)}.{nameof(Avx512BW.ConvertToVector512UInt16)} reflection invocation is not supported on this runtime.");
                return;
            }

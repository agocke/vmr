...
namespace SafeHandleTests
{
    public class InvalidSafeHandleMarshallingTests
    {
        ...
        [Xunit.SkipOnCoreClrAttribute("Depends on COM", (RuntimeTestModes)0x400)] // When on Win32, IsBuiltInComEnabled is found to be false, but enough of COM interop is in place to make this go down the InvalidOperationException path
